    ...
    return (
        <>
            ...
            <p className={styles.aboutText}>
                ...
                disposición de los mismos, y todo el software en el Sitio es Copyright (c) UnknownCoder <br />
                ...
                leyes de derechos de autor. Todo el software utilizado en los Sitios es propiedad de UnknownCoder o de sus proveedores de software <br />
